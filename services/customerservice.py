...
async def open_account(db:Session,payload:OpenAccountRequest,response:Response,setting:Setting,accountType:AccountLevelEnum,background_task: BackgroundTasks):
    try:
